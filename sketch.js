...
function preload(){
  ...
  racer1 = loadAnimation("images/mainPlayer1.png","images/mainPlayer2.png");
...
function draw() {
  ...
  if (World.frameCount % 150 == 0) {
   ...
   if(pinkCG.isTouching(mainCyclist)){
    ...
    textSize (20);
    text("Presiona la flecha hacia arriba para reiniciar",380,200);
...
gameState = PLAY;
gameOver.visible = false;
mainCyclist.addAnimation("SahilRunning",racer1);
